...
In the following experiments we explore two aspects of Piantadosi’s claim. In Simulation 1, we examine the efficient language *structure* aspect of their claim, exploring when the optimal linguistic system $\ell^*$ is most likely to contain ambiguous lexical items. In Simulation 2, we explore an efficient language *use* aspect of the claim -- at what point in a conversation is it useful for a speaker to use ambiguous lexical material?\par
