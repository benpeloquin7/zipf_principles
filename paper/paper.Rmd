...
To preview, we diverge from this approach in two ways. First we derive a measure of efficiency from first principles of \textit{efficient language use} and show how this can lead to communicatively efficient systems. Second we demonstrate how assumptions about language-users impacts whether language properties are used efficiently. In this way, we bridge questions of design and use in a single framework.\par
...
\vspace{1em} \fbox{\parbox[b][][c]{7.3cm}{\centering {Code and SI are available at this \href{https://github.com/benpeloquin7/zipf_principles/}{repository}.}}} \vspace{1em}
\noindent
