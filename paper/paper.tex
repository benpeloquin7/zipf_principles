...
To preview, we diverge from this approach in two ways. First we derive a
measure of efficiency from first principles of
...
we show \textit{how} ambiguity is used efficiently during local,
...
generally, it demonstrates how we can assess both questions of efficient
...
Figure 3, panel (A) shows the empirical probability that a speaker uses
an ambiguous utterance as a function of discourse position. The
...
\fbox{\parbox[b][][c]{7.3cm}{\centering {Code and SI are available at this \href{https://github.com/benpeloquin7/zipf_principles/}{repository}.}}}
\vspace{1em} \noindent
