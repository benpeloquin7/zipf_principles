...
demonstrate how assumptions about interlocutors impacts how language
...
is intended to demonstrates how we can assess both questions of
efficient use (current simulation) as well as design (previous
simulation) in the same framework.\par
...
\fbox{\parbox[b][][c]{7.3cm}{\centering {Code and SI: \href{https://bit.ly/2DOnjI4}{\url{https://bit.ly/2DOnjI4}}.}}}
\vspace{1em} \noindent
